...
class Veranstaltung(models.Model):
    ...
    def get_next_state(self):
        return self.STATUS_UEBERGANG[self.status]
    ...
    def log(self, interface):
        ...
        elif isinstance(interface, auth.User):
...
class Log(models.Model):
    ...
    user = models.ForeignKey(auth.User, null=True, related_name='user')
